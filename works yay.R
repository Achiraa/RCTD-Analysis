...
SpatialFeaturePlot(slide.seq, images = "slice1", features = "Injury induced fibrogenic cells", alpha = c(-0.5, 3),pt.size.factor = 4000)
SpatialFeaturePlot(slide.seq, images = "slice1", features = "Chondrocytes", alpha = c(-0.6, 4),pt.size.factor = 4000)
SpatialFeaturePlot(slide.seq, images = "slice1", features = "Stem_progenitors cells", alpha = c(-0.5, 4),pt.size.factor = 4000)
SpatialFeaturePlot(slide.seq, images = "slice1", features = "Osteoblasts", alpha = c(-0.5, 4),pt.size.factor = 4000)
SpatialFeaturePlot(slide.seq, images = "slice1", features = "Osteoclasts", alpha = c(-0.5, 4),pt.size.factor = 4000)
